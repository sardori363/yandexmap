...
import 'package:hw26/features/data/models/map_point.dart';
import 'package:hw26/features/data/services/app_location_service.dart';
import 'package:hw26/features/data/views/clusterized_icon_painter.dart';
import 'package:hw26/features/data/views/settings_page.dart';
          ...
          IconButton(
            onPressed: () async {
              _polygonPointsList = await Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => const YandexPage(),
                ),
              );
              setState(() {});
            },
